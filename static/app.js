...
!(function (e) {
                        ...
                        v = function () {
                            ...
                            if (o.length) {
                                if ("initializing" == e.state)
                                    return (
                                        console.log(
                                            "Syscall is initializing, waiting"
                                        ),
                    ...
                    return (
                        (h = setTimeout(v, t)),
                        {
                            ...
                            forceUpdate: function () {
                                h
                                    ? (clearTimeout(h), (h = setTimeout(v, 0)))
                                    : (f = !0);
                            },
                        }
                    );
                    ...
                    var r = {
                        ...
                        onclose: function (e) {
                            r.handles &&
                                r.handles.length &&
                                r.onerror(
                                    "Connection reset while calling aria2"
                                ),
                                (r.initialized = !1),
                                r.onready && (r.onready(), (r.onready = null));
                        },
                        ...
                        onmessage: function (e) {
                            for (
                                var n = t.parse(e.data),
                                    a = r.handles.length - 1;
                                a >= 0;
                                a--
                            )
                                if (r.handles[a].id === n.id)
                                    return (
                                        r.handles[a].success(n),
                                        void r.handles.splice(a, 1)
                                    );
                        },
                        invoke: function (e) {
                            var n = {
                        ...
                        init: function (e, t) {
                            ...
                            (r.conf = e || r.conf),
                                ...
                                r.sock &&
                                    ...
                                    r.onerror({
                                        message:
                                            "Changing the websocket aria2 server details",
                                    }));
                            try {
                                var n =
                                    r.scheme +
                                ...
                                console.log(
                                    "not using websocket for aria2 rpc due to: ",
                                    e
                                ),
                                    i.addAlert(
                                        "Web sockets not working due to " +
                                            e.message,
                                        "info"
                                    ),
                                    t();
                    ...
                    var a = (function () {
                        ...
                        o = {
                            ...
                            mergeMap: function (e, t, n) {
                                t || (t = []);
                                for (
                                    var a = 0, o = Math.min(e.length, t.length);
                                    a < o;
                                    ++a
                                )
                                    n(e[a], t[a]);
                                ...
                                r &&
                                    (function (e, t, n) {
                                        if (((t = t || []), e.getContext)) {
                                            ...
                                            console.log(
                                                "use chunk bar on an canvas implementation!"
                                            );
                                    })(
                                        n[0],
                                        e.getChunksFromHex(o, i),
                                        a.fillStyle
                                    );
                            };
        ...
        t.a = o.a
            ...
            .directive("dgraph", [
                ...
                function (e, t, n) {
                    ...
                    try {
                        /16/.test(
                            new Date(2e3, 0, 1, 16, 7, 9).toLocaleTimeString()
                        ) || (a = "%I:%M:%S %P");
                    } catch (e) {}
                    return function (n, i, r) {
                        ...
                        n.$watch(r.dspeed, function (e) {
                            void 0 !== e &&
                                ((u = !0), (c = parseFloat(e) || 0));
                        }),
                            n.$watch(r.uspeed, function (e) {
                                void 0 !== e &&
                                    ((u = !0), (d = parseFloat(e) || 0));
                            }),
                ...
                function (e, t, n, a, o, i, r, s, l, c, d, u, p, h, f) {
                    ...
                    (e.active = []),
                        ...
                        (e.canRestart = function (e) {
                            return (
                                -1 == ["active", "paused"].indexOf(e.status) &&
                                !e.bittorrent
                            );
                        }),
                        ...
                        a.subscribe("getGlobalStat", [], function (t) {
                            e.$apply(function () {
                                (e.gstats = t[0]),
                                    (h.pageTitle = i.getTitle(e.gstats));
                            });
                        }),
                        ...
                        (e.onDownloadFilter = function () {
                            e.downloadFilterTimer &&
                                clearTimeout(e.downloadFilterTimer),
                                (e.downloadFilterTimer = setTimeout(
                                    function () {
                            ...
                            t
                                ? (t.gid !== e.gid && (t.files = []),
                                  ...
                                  t.totalLength !== e.totalLength &&
                                      ((t.totalLength = e.totalLength),
                                      (t.fmtTotalLength = i.fmtsize(
                                          e.totalLength
                                      ))),
                                  t.completedLength !== e.completedLength &&
                                      ((t.completedLength = e.completedLength),
                                      (t.fmtCompletedLength = i.fmtsize(
                                          e.completedLength
                                      ))),
                                  e.verifiedLength
                                  ...
                                  t.uploadLength !== e.uploadLength &&
                                      ((t.uploadLength = e.uploadLength),
                                      (t.fmtUploadLength = i.fmtsize(
                                          e.uploadLength
                                      ))),
                                  t.pieceLength !== e.pieceLength &&
                                      ((t.pieceLength = e.pieceLength),
                                      (t.fmtPieceLength = i.fmtsize(
                                          e.pieceLength
                                      ))),
                                  t.downloadSpeed !== e.downloadSpeed &&
                                      ((t.downloadSpeed = e.downloadSpeed),
                                      (t.fmtDownloadSpeed = i.fmtspeed(
                                          e.downloadSpeed
                                      ))),
                                  t.uploadSpeed !== e.uploadSpeed &&
                                      ((t.uploadSpeed = e.uploadSpeed),
                                      (t.fmtUploadSpeed = i.fmtspeed(
                                          e.uploadSpeed
                                      ))))
                                : ((t = {
                                      dir: e.dir,
                        ...
                        (e.getType = function (e) {
                            ...
                            return (
                                "paused" == t && (t = "waiting"),
                                -1 !=
                                    ["error", "removed", "complete"].indexOf(
                                        t
                                    ) && (t = "stopped"),
                                t
                            );
                        ...
                        open: function (a) {
                            ...
                            (this.uris = ""),
                                ...
                                e.forEach(s, function (e) {
                                    (o.settings[e] = o.fsettings[e]),
                                        delete o.fsettings[e];
                                }),
                                (this.inst = n.open({
                                ...
                                this.inst.result.then(
                                    function () {
                                        if ((delete o.inst, o.cb)) {
                                            ...
                                            console.log("sending settings:", e),
                                                o.cb(o.parse(), e);
                                        }
                                    },
                                    function () {
                            ...
                            t[a] = {
                                open: function (o) {
                                    ...
                                    (this.files = []),
                                        ...
                                        (this.fsettings = e.cloneDeep(r)),
                                        e.forEach(s, function (e) {
                                            (l.settings[e] = l.fsettings[e]),
                                                delete l.fsettings[e];
                                        }),
                                        (this.inst = n.open({
                                            templateUrl: a + ".html",
                                            scope: t,
                            ...
                            n.once("getGlobalOption", [], function (e) {
                                ...
                                t.invoke(
                                    ...
                                    function (e) {
                                        ...
                                        console.log(
                                            "saving aria2 settings:",
                                            t
                                        ),
                                            console.log(
                                                "saving aria2 starred:",
                                                a
                                            ),
                    ...
                    (e._props = []),
                        ...
                        (e.enabled = function () {
                            for (var t = 0; t < e.properties.length; t++)
                                if (e.properties[t]._val != e.properties[t].val)
                                    return !0;
                            return !1;
                        }),
                        (e.save = function () {
                            for (
                                var t = {}, n = !1, o = 0;
                                o < e.properties.length;
                                o++
                            )
                                e.properties[o]._val != e.properties[o].val &&
                                    ((t[e.properties[o].name] =
                                        e.properties[o].val),
                                    (n = !0));
                ...
                $.config([
                    ...
                    function (e, t) {
                        e
                            ...
                            .translations(
                                "nl_NL",
                                M(translations.nl_NL, translations.en_US)
                            )
                            .translations(
                                "th_TH",
                                M(translations.th_TH, translations.en_US)
                            )
                            .translations(
                                "zh_CN",
                                M(translations.zh_CN, translations.en_US)
                            )
                            .translations(
                                "zh_TW",
                                M(translations.zh_TW, translations.en_US)
                            )
                            .translations(
                                "pl_PL",
                                M(translations.pl_PL, translations.en_US)
                            )
                            .translations(
                                "fr_FR",
                                M(translations.fr_FR, translations.en_US)
                            )
                            .translations(
                                "de_DE",
                                M(translations.de_DE, translations.en_US)
                            )
                            .translations(
                                "es_ES",
                                M(translations.es_ES, translations.en_US)
                            )
                            .translations(
                                "ru_RU",
                                M(translations.ru_RU, translations.en_US)
                            )
                            .translations(
                                "it_IT",
                                M(translations.it_IT, translations.en_US)
                            )
                            .translations(
                                "tr_TR",
                                M(translations.tr_TR, translations.en_US)
                            )
                            .translations(
                                "cs_CZ",
                                M(translations.cs_CZ, translations.en_US)
                            )
                            .translations(
                                "fa_IR",
                                M(translations.fa_IR, translations.en_US)
                            )
                            .translations(
                                "id_ID",
                                M(translations.id_ID, translations.en_US)
                            )
                            .translations(
                                "pt_BR",
                                M(translations.pt_BR, translations.en_US)
                            )
    ...
    function (e, t) {
        angular.module("ui.bootstrap", [
                            ...
                            t.find("input").css({ display: "none" }),
                                ...
                                t.bind(o.toggleEvent, function () {
                                    if (!n.disabled) {
                                        ...
                                        (!a ||
                                            angular.isDefined(n.uncheckable)) &&
                                            e.$apply(function () {
                                                i.$setViewValue(
                                                    a
                                                        ? null
            ...
            angular
                ...
                .controller("CarouselController", [
                    ...
                    function (e, t, n, a) {
                        ...
                        (u.select = e.select = function (t, n) {
                            ...
                            void 0 === n &&
                                (n = a > u.getCurrentIndex() ? "next" : "prev"),
                                t &&
                                    t !== u.currentSlide &&
                                    !e.$currentTransition &&
                                    o(t, a, n);
                            ...
                            (u.getCurrentIndex = function () {
                                return u.currentSlide &&
                                    angular.isDefined(u.currentSlide.index)
                                    ? +u.currentSlide.index
                                    : m;
                            }),
                            (e.indexOfSlide = function (e) {
                                return angular.isDefined(e.index)
                                    ? +e.index
                                    : p.indexOf(e);
                            }),
                            (e.next = function () {
                ...
                .directive("slide", function () {
                    return {
                        ...
                        templateUrl: function (e, t) {
                            return (
                                t.templateUrl || "template/carousel/slide.html"
                            );
                        },
                    ...
                    function (e, t, n) {
                        ...
                        var i = {
                            ...
                            MMMM: {
                                ...
                                apply: function (e) {
                                    this.month = t.DATETIME_FORMATS.MONTH.indexOf(
                                        e
                                    );
                                },
                            },
                            MMM: {
                                ...
                                apply: function (e) {
                                    this.month = t.DATETIME_FORMATS.SHORTMONTH.indexOf(
                                        e
                                    );
                                },
                            },
                        ...
                        this.parse = function (n, i, r) {
                            ...
                            (i = (i = t.DATETIME_FORMATS[i] || i).replace(
                                o,
                                "\\$&"
                            )),
                ...
                .controller("DatepickerController", [
                    ...
                    function (e, t, n, a, o, i, r, s) {
                        ...
                        (this.modes = ["day", "month", "year"]),
                            ...
                            (e.datepickerMode =
                                e.datepickerMode || r.datepickerMode),
                            (e.uniqueId =
                                "datepicker-" +
                                e.$id +
                                "-" +
                            ...
                            angular.isDefined(t.initDate)
                                ? ((this.activeDate =
                                      e.$parent.$eval(t.initDate) ||
                                      new Date()),
                                  e.$parent.$watch(t.initDate, function (e) {
                                      e &&
                                          (c.$isEmpty(c.$modelValue) ||
                                              c.$invalid) &&
                            ...
                            (this.isDisabled = function (n) {
                                return (
                                    (this.minDate &&
                                        this.compare(n, this.minDate) < 0) ||
                                    (this.maxDate &&
                                        this.compare(n, this.maxDate) > 0) ||
                                    (t.dateDisabled &&
                                        e.dateDisabled({
                                            date: n,
                            ...
                            (e.move = function (e) {
                                var t =
                                        l.activeDate.getFullYear() +
                                        e * (l.step.years || 0),
                                    n =
                                        l.activeDate.getMonth() +
                                        e * (l.step.months || 0);
                            ...
                            (e.toggleMode = function (t) {
                                (t = t || 1),
                                    (e.datepickerMode === l.maxMode &&
                                        1 === t) ||
                                        (e.datepickerMode === l.minMode &&
                                            -1 === t) ||
                                        (e.datepickerMode =
                                            l.modes[
                                                l.modes.indexOf(
                        ...
                        return {
                            ...
                            link: function (c, d, u, p) {
                                ...
                                var f,
                                    ...
                                    y = {};
                                (c.showButtonBar = angular.isDefined(
                                    u.showButtonBar
                                )
                                    ...
                                    (c.isDisabled = function (e) {
                                        return (
                                            "today" === e && (e = new Date()),
                                            (c.watchData.minDate &&
                                                c.compare(e, y.minDate) < 0) ||
                                                (c.watchData.maxDate &&
                                                    c.compare(e, y.maxDate) > 0)
                                        );
                                    }),
                    ...
                    function (e, t, n, a, o, i, r, s, l, c) {
                        ...
                        (this.init = function (a) {
                            ...
                            (this.toggle = function (e) {
                                return (h.isOpen = arguments.length
                                    ? !!e
                                    : !h.isOpen);
                            }),
                            ...
                            h.$watch("isOpen", function (t, n) {
                                ...
                                if (
                                    ...
                                    p.dropdownMenuTemplateUrl &&
                                        c(p.dropdownMenuTemplateUrl).then(
                                            function (e) {
                                                (d = h.$new()),
                                                    l(e.trim())(d, function (
                                                        e
            ...
            angular
                ...
                .directive("modalAnimationClass", [
                    function () {
                        return {
                            compile: function (e, t) {
                                t.modalAnimation &&
                                    e.addClass(t.modalAnimationClass);
                            },
                        };
                    },
                ])
                ...
                .factory("$modalStack", [
                    ...
                    function (e, t, n, a, o, i, r, s, l) {
                        ...
                        function p(e, t, n) {
                            return !e.value.modalScope.$broadcast(
                                "modal.closing",
                                t,
                                n
                            ).defaultPrevented;
                        ...
                        return (
                            ...
                            (y.focusLastFocusableElement = function () {
                                return (
                                    g.length > 0 &&
                                    (g[g.length - 1].focus(), !0)
                                );
                            }),
                            (y.isFocusInFirstItem = function (e) {
                                return (
                                    g.length > 0 &&
                                    (e.target || e.srcElement) == g[0]
                                );
                            }),
                            ...
                            (this.calculateTotalPages = function () {
                                var t =
                                    this.itemsPerPage < 1
                                        ? 1
                                        : Math.ceil(
                                              e.totalItems / this.itemsPerPage
                                          );
                                ...
                                if (l) {
                                    var c = angular.isDefined(o.maxSize)
                                        ...
                                        d = angular.isDefined(o.rotate)
                                            ...
                                            : t.rotate;
                                    (n.boundaryLinks = angular.isDefined(
                                        o.boundaryLinks
                                    )
                                        ? n.$parent.$eval(o.boundaryLinks)
                                        : t.boundaryLinks),
                                        (n.directionLinks = angular.isDefined(
                                            o.directionLinks
                                        )
                        ...
                        return {
                            link: function (o, i, r) {
                                var s,
                                    ...
                                    c,
                                    d = o.$eval(
                                        r.tooltipTemplateTranscludeScope
                                    ),
                                    u = 0,
                                    p = function () {
                                        l && (l.remove(), (l = null)),
                                ...
                                o.$watch(
                                    t.parseAsResourceUrl(
                                        r.tooltipTemplateTransclude
                                    ),
                                    function (t) {
                                        var r = ++u;
                                        t
                    ...
                    return {
                        ...
                        link: function (e, t, n) {
                            e.placement && t.addClass(e.placement),
                                ...
                                e.animation() &&
                                    t.addClass(n.tooltipAnimationClass);
                        },
                    };
                })
            ...
            angular
                ...
                .directive("tabset", function () {
                    return {
                        ...
                        link: function (e, t, n) {
                            (e.vertical =
                                !!angular.isDefined(n.vertical) &&
                                e.$parent.$eval(n.vertical)),
                                (e.justified =
                    ...
                    function (e, t, n, a, o, i) {
                        ...
                        this.init = function (n, a) {
                            ...
                            (angular.isDefined(t.mousewheel)
                                ...
                                (e.readonlyInput = angular.isDefined(
                                    t.readonlyInput
                                )
                        ...
                        t.minuteStep &&
                            ...
                            (e.noToggleMeridian = function () {
                                return f.getHours() < 13
                                    ? p(f, 720) > w
                                    : p(f, -720) < b;
                            }),
                            (e.showMeridian = i.showMeridian),
                            t.showMeridian &&
                                e.$parent.$watch(n(t.showMeridian), function (
                                    t
                                ) {
                                    if (
                                        ((e.showMeridian = !!t), m.$error.time)
                                    ) {
                                        var n = r(),
                                            a = s();
                                        angular.isDefined(n) &&
                        ...
                        return {
                            ...
                            link: function (u, p, h, f) {
                                ...
                                var y,
                                    ...
                                    C =
                                        t(h.typeaheadLoading).assign ||
                                        angular.noop,
                                    P = t(h.typeaheadOnSelect),
                                    A =
                                        !!angular.isDefined(
                                            h.typeaheadSelectOnBlur
                                        ) && u.$eval(h.typeaheadSelectOnBlur),
                                    x =
                                        t(h.typeaheadNoResults).assign ||
                                        angular.noop,
                                ...
                                O.attr({
                                    ...
                                    angular.isDefined(h.typeaheadTemplateUrl) &&
                                        O.attr(
                                            "template-url",
                                            h.typeaheadTemplateUrl
                                        ),
                                    angular.isDefined(
                                        h.typeaheadPopupTemplateUrl
                                    ) &&
                                        O.attr(
                                            "popup-template-url",
                                            h.typeaheadPopupTemplateUrl
                                    ...
                                    (U.select = function (e) {
                                        ...
                                        (k = !0),
                                            ...
                                            P(u, {
                                                $item: n,
                                                $model: t,
                                                $label: z.viewMapper(u, o),
                                            }),
                                            B(),
                                            !1 !==
                                                U.$eval(
                                                    h.typeaheadFocusOnSelect
                                                ) &&
                                                a(
                                                    function () {
                                                        p[0].focus();
            ...
            angular
                .module("template/tooltip/tooltip-template-popup.html", [])
                .run([
                    "$templateCache",
                    function (e) {
                        e.put(
                        ...
                        ("" !== r && r) ||
                            ...
                            o.$element.change(function () {
                                ...
                                0 == o.options.input && o.options.badge
                                    ? 0 ==
                                      o.$elementFilestyle.find(".badge").length
                                        ? o.$elementFilestyle
                                              .find("label")
                                              .append(
                                                  ' <span class="badge">' +
                            ...
                            window.navigator.userAgent.search(/firefox/i) >
                                -1 &&
                                o.$elementFilestyle
                                    .find("label")
                                    .click(function () {
                    ...
                    var o = "",
                        i = this.each(function () {
                            if ("file" === e(this).attr("type")) {
                                ...
                                r ||
                                    (i.data("filestyle", (r = new n(this, s))),
                                    r.constructor()),
            ...
            !(function (e) {
                (e.color = {}),
                    ...
                    (e.color.parse = function (n) {
                        ...
                        if (
                            (a = /#([a-fA-F0-9])([a-fA-F0-9])([a-fA-F0-9])/.exec(
                                n
                            ))
                        )
                            return o(
                    ...
                    function a(t, a, o, i) {
                                ...
                                (function () {
                                    ...
                                    for (t = 0; t < r.length; ++t) {
                                        ...
                                        if (null == i.datapoints.pointsize) {
                                            ...
                                            var k =
                                                i.lines.show && i.lines.steps;
                                            for (
                                                i.xaxis.used = i.yaxis.used = !0,
                                                    n = a = 0;
                                                n < p.length;
                                                ++n, a += l
                                            ) {
                        ...
                        function R() {
                            ...
                            if (
                                ...
                                !(function () {
                                    ...
                                    e.each(T(), function (e, t) {
                                        ...
                                        (m.left = Math.ceil(
                                            Math.max(a.left, m.left)
                                        )),
                                        (m.right = Math.ceil(
                                            Math.max(a.right, m.right)
                                        )),
                                        (m.top = Math.ceil(
                                            Math.max(a.top, m.top)
                                        )),
                                        (m.bottom = Math.ceil(
                                            Math.max(a.bottom, m.bottom)
                                        ));
                                })(),
                            ...
                            (g = l.width - m.left - m.right),
                                ...
                                (function () {
                                    ...
                                    if (s.legend.sorted)
                                        if (e.isFunction(s.legend.sorted))
                                            i.sort(s.legend.sorted);
                                        else if ("reverse" == s.legend.sorted)
                                            i.reverse();
                                        else {
                                            var u =
                                                "descending" != s.legend.sorted;
                                            i.sort(function (e, t) {
                        ...
                        function I(e) {
                            e.lines.show &&
                                (function (e) {
                                    ...
                                    n > 0 &&
                                        t(e.datapoints, 0, 0, e.xaxis, e.yaxis);
                                    u.restore();
                                })(e),
                                e.bars.show &&
                                    (function (e) {
                        ...
                        (w.setData = k),
                            ...
                            (w.pointOffset = function (e) {
                                return {
                                    left: parseInt(
                                        h[S(e, "x") - 1].p2c(+e.x) + m.left,
                                        10
                                    ),
                                    top: parseInt(
                                        f[S(e, "y") - 1].p2c(+e.y) + m.top,
                                        10
                                    ),
                                };
                            }),
                            ...
                            (function () {
                                for (
                                    ...
                                    var o = i[a];
                                    o.init(w, t),
                                        o.options && e.extend(!0, s, o.options);
                                }
                            })(),
                            (function (n) {
                                e.extend(!0, s, n),
                                    n && n.colors && (s.colors = n.colors);
                                null == s.xaxis.color &&
                                ...
                                null == s.xaxis.tickColor &&
                                    (s.xaxis.tickColor =
                                        s.grid.tickColor || s.xaxis.color);
                                null == s.yaxis.tickColor &&
                                    (s.yaxis.tickColor =
                                        s.grid.tickColor || s.yaxis.color);
                                ...
                                for (i = s.xaxes.length || 1, a = 0; a < i; ++a)
                                    (o = s.xaxes[a]) &&
                                        ...
                                        o.font &&
                                            ...
                                            o.font.color ||
                                                (o.font.color = o.color),
                                            o.font.lineHeight ||
                                                (o.font.lineHeight = Math.round(
                                                    1.15 * o.font.size
                                                )));
                                ...
                                s.grid.coloredAreasColor &&
                                    (s.grid.markingsColor =
                                        s.grid.coloredAreasColor);
                                s.lines &&
                                    e.extend(!0, s.series.lines, s.lines);
                                s.points &&
                                    e.extend(!0, s.series.points, s.points);
                                s.bars && e.extend(!0, s.series.bars, s.bars);
                                null != s.shadowSize &&
                                    (s.series.shadowSize = s.shadowSize);
                                null != s.highlightColor &&
                                    (s.series.highlightColor =
                                        s.highlightColor);
                            ...
                            (function () {
                                s.grid.hoverable &&
                                    (d.mousemove(F), d.bind("mouseleave", O));
                        ...
                        function j(e, n, a) {
                            ...
                            if (
                                (u &&
                                    ((u.pageX = parseInt(
                                        u.series.xaxis.p2c(u.datapoint[0]) +
                                            o.left +
                                            m.left,
                                        10
                                    )),
                                    (u.pageY = parseInt(
                                        u.series.yaxis.p2c(u.datapoint[1]) +
                                            o.top +
                                            m.top,
                                        10
                                    ))),
                        ...
                        function W(e, t, n) {
                            ...
                            var o = Y(e, t);
                            -1 == o
                                ? (U.push({ series: e, point: t, auto: n }),
                                  N())
                                : n || (U[o].auto = !1);
                        }
                        function V(e, t) {
                        ...
                        function q(t, n) {
                            ...
                            if (
                                ...
                                var l =
                                    t.points.radius + t.points.lineWidth / 2;
                    ...
                    e.fn.detach ||
                        ...
                        (n.prototype.removeText = function (e, n, a, o, i, r) {
                            if (null == o) {
                                ...
                                var h;
                                for (
                                    u = this.getTextInfo(e, o, i, r).positions,
                                        p = 0;
                                    (h = u[p]);
                                    p++
                                )
                                ...
                                "time" == r.mode &&
                                    ((a.tickGenerator = function (e) {
                                        ...
                                        "second" == h
                                            ...
                                            v >= 2 * i.month &&
                                                a.setMonth(t(a.getMonth(), 3)),
                                            v >= 2 * i.quarter &&
                                                a.setMonth(t(a.getMonth(), 6)),
        ...
        "undefined" == typeof translations && (translations = {}),
            (translations.nl_NL = {
                ...
                "Add Downloads By Metalinks":
                    "Download toevoegen met Metalinks",
                ...
                "Enter base URL (optional)":
                    "Invoeren van de basis URL (facultatief)",
    ...
    function (e, t) {
        "undefined" == typeof translations && (translations = {}),
            (translations.pl_PL = {
                ...
                "Add Downloads By Metalinks":
                    "Dodaj pobierania przez Metalinki",
                ...
                "Enter the password (optional)":
                    "Wprowadź hasło (opcja dodatkowa)",
                "Enter the Aria2 RPC password (empty if authentication not enabled)":
                ...
                "Save Connection configuration":
                    "Zapisz konfigurację połączenia",
                Filter: "Filtr",
        ...
        "undefined" == typeof translations && (translations = {}),
            (translations.fr_FR = {
                ...
                "Add Downloads By URIs":
                    "Ajouter des téléchargements depuis des URIs",
                "- You can add multiple downloads (files) at the same time by putting URIs for each file on a separate line.":
    ...
    function (e, t) {
        "undefined" == typeof translations && (translations = {}),
            (translations.de_DE = {
                ...
                "Add Downloads By Torrents":
                    "Downloads mit Torrents hinzufügen",
                "- Select the torrent from the local filesystem to start the download.":
                ...
                "Add Downloads By Metalinks":
                    "Download mit Metalinks hinzufügen",
                ...
                "Enable SSL/TLS encryption":
                    "Aktiviere SSL/TLS Verschlüsselung",
                ...
                "Save Connection configuration":
                    "Speichern der Verbindungseinstellung",
                Filter: "Filter",
                "Aria2 server info": "Aria2 Server Info",
                "Aria2 Version": "Aria2 Version",
    ...
    function (e, t) {
        "undefined" == typeof translations && (translations = {}),
            (translations.ru_RU = {
                ...
                "Add Downloads By Torrents":
                    "Добавить загрузку из Torrent-файлов",
                "- Select the torrent from the local filesystem to start the download.":
                ...
                "Add Downloads By Metalinks":
                    "Добавить загрузку из Metalink-файлов",
        ...
        "undefined" == typeof translations && (translations = {}),
            (translations.it_IT = {
                ...
                "Aria2 RPC host and port":
                    "Host e porta del server RPC di Aria2",
    ...
    function (e, t) {
        "undefined" == typeof translations && (translations = {}),
            (translations.tr_TR = {
                ...
                "Add Downloads By Torrents":
                    "Torrent kullanarak indirmelere ekle",
                "- Select the torrent from the local filesystem to start the download.":
                ...
                "Add Downloads By Metalinks":
                    "Metalink kullanarak indirmelere ekle",
                ...
                "Save Connection configuration":
                    "Bağlantı yapılandırmasını kaydedin",
                Filter: "Filtre",
    ...
    function (e, t) {
        "undefined" == typeof translations && (translations = {}),
            (translations.cs_CZ = {
                ...
                "Add Downloads By Metalinks":
                    "Přidat stahovní pomocí metalinku",
    ...
    function (e, t) {
        "undefined" == typeof translations && (translations = {}),
            (translations.pt_BR = {
                ...
                "Add Downloads By Metalinks":
                    "Adicionar Downloads por Metalinks",
